...
// <copyright file="StateBuilder.cs"  
...
namespace StateMachine.AsyncMachine
{
        ...
        where TEvent : IComparable
    {
        ...
        /// <returns>Exit action syntax.</returns>
        IEntryActionSyntax<TState, TEvent> IEntryActionSyntax<TState, TEvent>.ExecuteOnEntryParametrized<T>(Func<T, Task> action, T parameter)
        {
        ...
        /// <returns>Exit action syntax.</returns>
        IExitActionSyntax<TState, TEvent> IExitActionSyntax<TState, TEvent>.ExecuteOnExitParametrized<T>(Func<T, Task> action, T parameter)
        {
